{
    ...
    "input": {
        "values": [{
            ...
            "description": "hwRectsRatedVoltage",
            "name": "hwRectsRatedVoltage",
            "sql_type": "INTEGER",
            "reg": ".1.3.6.1.4.1.2011.6.164.1.3.1.5.0",
            "community": "sread",
            "ip": "10.0.0.3",
            "oid": ".1.3.6.1.4.1.47480.5.1",
            "type": "snmp_reg",
            "bus": "snmp_bus",
            "default": 0,
            "intervals": {
            ...
            "description": "hwRectsTotalCurrent",
            "name": "hwRectsTotalCurrent",
            "sql_type": "INTEGER",
            "reg": ".1.3.6.1.4.1.2011.6.164.1.3.1.3.0",
            "community": "sread",
            "ip": "10.0.0.3",
            "oid": ".1.3.6.1.4.1.47480.5.2",
            "type": "snmp_reg",
            "bus": "snmp_bus",
            "default": 0,
            "intervals": {
    ...
    "output": {
        "values": [{
            ...
            "description": "hwSetBattsHighTempAction",
            "name": "hwSetBattsHighTempAction",
            "sql_type": "INTEGER",
            "reg": ".1.3.6.1.4.1.2011.6.164.1.4.1.4.0",
            "community": "swrite",
            "ip": "10.0.0.3",
            "oid": ".1.3.6.1.4.1.47480.5.3",
            "default": 1,
            "type": "snmp_reg",
            "bus": "snmp_bus",
            "intervals": {
